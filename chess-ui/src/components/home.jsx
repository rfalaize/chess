                    ...
                    <div className="container my-auto">
                        <div className="row">
                            <div className="col-lg-10 mx-auto">
                                <h2>
                                    <strong>This is a project sandbox</strong>
                                </h2>
                                <hr />
                            </div>
                            <div className="col-lg-8 mx-auto">
                                ...
                                <br />
                                <a className="btn btn-primary btn-xl js-scroll-trigger" href="/chess">
                                    Play chess
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="row">
                            <div className="col-lg-3 col-md-6 text-center">
                                <div className="service-box mt-5 mx-auto">
                                    ...
                                    <p className="text-muted mb-0">Supervised, Unsupervised and Reinforcement Learning.</p>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-6 text-center">
                                <div className="service-box mt-5 mx-auto">
                                    ...
                                    <p className="text-muted mb-0">Constrained optimization, Mixed Integer and Dynamic Programming.</p>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-6 text-center">
                                <div className="service-box mt-5 mx-auto">
                                    ...
                                    <p className="text-muted mb-0">Mostly python, C#, javascript, q.</p>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-6 text-center">
                                <div className="service-box mt-5 mx-auto">
                                    ...
                                    <p className="text-muted mb-0">Quantum physics... and computing!</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row no-gutters popup-gallery">
                            <div className="col-lg-6 col-sm-6">
                                <a className="portfolio-box" href="/chess">
                                    <img className="img-fluid" src={require("./../assets/img/portfolio/chess-pieces.jpg")} alt="" />
                                    <div className="portfolio-box-caption">
                                        <div className="portfolio-box-caption-content">
                                            <div className="project-category text-faded">Reinforcement Learning</div>
                            ...
                            <div className="col-lg-6 col-sm-6">
                                <a className="portfolio-box" href="/particles">
                                    <img className="img-fluid" src={require("./../assets/img/portfolio/planets.jpg")} alt="" />
                                    <div className="portfolio-box-caption">
                                        <div className="portfolio-box-caption-content">
                                            <div className="project-category text-faded">Animations</div>
                            ...
                            <div className="col-lg-6 col-sm-6">
                                <a className="portfolio-box" href="/cube">
                                    <img className="img-fluid" src={require("./../assets/img/portfolio/dice.jpg")} alt="" />
                                    <div className="portfolio-box-caption">
                                        <div className="portfolio-box-caption-content">
                                            <div className="project-category text-faded">3D modelling</div>
