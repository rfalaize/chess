            ...
            <div className="bg">
                <div className="absolute-center is-responsive mx-auto">
                        ...
                        <div className="card-body">
                            ...
                            <form className="form-signin">
                                ...
                                <div className="form-label-group">
                                    ...
                                    <select id="algo" className="form-control" value={this.state.algo} onChange={this.handleChange}>
                  ...
                  />
                                ...
                                <button className="btn btn-lg btn-primary btn-block text-uppercase" type="submit" onClick={this.handleClick}>
                                    Play
                                </button>
                            </form>
                        </div>
