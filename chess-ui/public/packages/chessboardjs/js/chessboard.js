...
/*
 * Modified for deep-chess
 * added single-click piece selection
 */
  ...
  window["ChessBoard"] =
    ...
    function(containerElOrId, cfg) {
      ...
      function dropClickedPieceOnSquare(square) {
        ...
        var complete = function() {
          drawPositionInstant();
          clickedPieceEl.css("display", "none");
          ...
          if (
            ...
            cfg.onSnapEnd(CLICKED_PIECE_SOURCE, square, CLICKED_PIECE);
          }
        };
        ...
        clickedPieceEl.animate(targetSquarePosition, opts);
      }
      ...
      function onEmptySquareClick(source) {
      ...
      function mousedownSquare(e) {
        ...
        if (
          ...
          onEmptySquareClick(square);
          return;
        }

        onPieceClick(square, CURRENT_POSITION[square]);
      ...
      function initDom() {
        ...
        var clickedPieceId = createId();
        $("body").append(buildPiece("wP", true, draggedPieceId));
        $("body").append(buildPiece("wP", true, clickedPieceId));
        draggedPieceEl = $("#" + draggedPieceId);
        clickedPieceEl = $("#" + clickedPieceId);
